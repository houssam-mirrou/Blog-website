                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="bg-slate-800 rounded-t-lg border border-slate-700 p-2 flex items-center gap-1 sticky top-16 z-40">
                        <button type="button" class="p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded transition" title="Bold">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 12h8a4 4 0 100-8H6v8zm0 0l-2 2m2-2L6 4"></path>
                            </svg>
                        </button>
                    ...
                    <textarea
                        ...
                        placeholder="Write your story here using Markdown..."></textarea>
                    ...
                    <div class="bg-slate-800 rounded-xl border border-slate-700 p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-slate-600 border-dashed rounded-lg cursor-pointer hover:bg-slate-700/50 hover:border-blue-500 transition group">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg class="w-8 h-8 mb-3 text-slate-500 group-hover:text-blue-500 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="mb-6">
                            ...
                            <select
                                name="category_ids[]"
                                multiple
                                class="w-full h-32 bg-slate-900 border border-slate-600 text-slate-300 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none overflow-y-auto">
                                <?php foreach ($categories as $cat): ?>
                                    <option value="<?= $cat->get_id() ?>">
                            ...
                            <p class="text-xs text-slate-500 mt-2">
                                * Hold <strong>Ctrl</strong> (Windows) or <strong>Command</strong> (Mac) to select multiple items.
                            </p>
                        </div>
