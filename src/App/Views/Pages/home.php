                ...
                <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 justify-center md:justify-start">
                    ...
                    if (isset($_SESSION['current_user'])) {
                        if ($_SESSION['current_user']->get_role() == 'admin') {
                            echo '<a href="dashboard-admin" class="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-lg font-bold transition text-center shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50">
                                Manage The Website
                            </a>';
                        } else {
                            echo '<a href="create-article" class="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-lg font-bold transition text-center shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50">
                                Write an Article
                            </a>';
                        }
                    } else {
                        echo '<a href="register" class="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-lg font-bold transition text-center shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50">
                                Start Writing
                            </a>';
                    }
                    ?>
...
<div id="latest" class="bg-slate-900 min-h-screen">
    <div class="container mx-auto px-6 py-12 flex flex-col md:flex-row gap-12">
                        ...
                        <div class="p-6 sm:w-2/3 flex flex-col justify-between">
                            <div>
                                <div class="flex items-center space-x-2 text-xs text-slate-400 mb-3">
                                    ...
                                    ?>
                                    <span>•</span>
                                    <span><?= $article['article']->get_created_date() ?></span>
                                </div>
                                ...
                                <p class="text-slate-400 text-sm line-clamp-2">
                                    <?= substr($article['article']->get_body(), 0, 50) . '...' ?>
                                </p>
                            </div>
                            <div class="mt-4 flex items-center">
                                ...
                                <span class="ml-2 text-sm font-medium text-slate-300"><?= $article['art_user'] ?></span>
                            </div>
                        </div>
                    </article>
                <?php
        ...
        <aside class="md:w-1/3 space-y-8">
            ...
            <?php
            if (!isset($_SESSION['current_user'])) {
                echo '<div class="bg-gradient-to-br from-blue-900 to-slate-900 p-6 rounded-xl shadow-lg border border-blue-800/50 text-white relative overflow-hidden">
